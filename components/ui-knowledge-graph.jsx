  ...
  return (
    <div className="bg-gray-800 rounded-lg p-4 h-full flex flex-col">
      <div className="flex justify-between items-center mb-4">
        <h2 className="text-xl font-bold text-white">Knowledge Graph: Carbon Insetting</h2>
      ...
      <div className="flex-1 bg-gray-900 rounded relative">
        ...
        <svg width="100%" height="100%">
          ...
          <g transform="translate(400, 300)">
            ...
            <text x="0" y="0" textAnchor="middle" fill="#000" fontWeight="bold" fontSize="12">Carbon Insetting</text>
          ...
          <g transform="translate(250, 200)">
            ...
            <text x="0" y="0" textAnchor="middle" fill="#fff" fontWeight="bold" fontSize="12">Supply Chain</text>
          ...
          <g transform="translate(550, 200)">
            ...
            <text x="0" y="0" textAnchor="middle" fill="#000" fontWeight="bold" fontSize="12">Carbon Credits</text>
          ...
          <g transform="translate(250, 400)">
            ...
            <text x="0" y="0" textAnchor="middle" fill="#000" fontWeight="bold" fontSize="12">Sustainability</text>
          ...
          <g transform="translate(550, 400)">
            ...
            <text x="0" y="0" textAnchor="middle" fill="#fff" fontWeight="bold" fontSize="12">ESG Reporting</text>
