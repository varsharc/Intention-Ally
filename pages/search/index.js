...
import { PlusCircle, Tag, Search, RefreshCw, List, BarChart2, Network, ArrowLeft } from 'lucide-react';
      ...
      <header className="bg-black p-4 border-b border-yellow-600">
        <div className="flex items-center justify-between max-w-screen-xl mx-auto">
          ...
          <div className="flex items-center space-x-4">
            <Link href="/" className="px-4 py-2 bg-gray-800 text-white rounded-md flex items-center hover:bg-gray-700 transition-colors">
  ...
  return (
    <AppLayout>
      ...
      <div className="bg-gray-950 p-5 rounded-lg shadow-lg mb-6 border border-gray-800">
        <div className="flex justify-between items-center">
          <div>
            ...
            <p className="text-gray-400">Last updated: March 22, 2025 • 24 sources • 3 clusters discovered</p>
          </div>
          
          <div className="flex space-x-4">
            <button className="bg-gray-800 hover:bg-gray-700 text-white px-4 py-2 rounded-md flex items-center space-x-2 transition-colors shadow-md">
              <PlusCircle size={18} />
        ...
        <div className="mt-4 pt-4 border-t border-gray-800">
          ...
          <div className="flex flex-wrap gap-2">
            {selectedTags.map((tag, index) => (
              <span key={index} className="bg-yellow-500 bg-opacity-20 text-yellow-500 px-3 py-1 rounded-full text-sm border border-yellow-500 border-opacity-30">
                {tag}
              </span>
            ))}
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 mb-6">
        ...
        <div>
          <div className="flex items-center mb-3">
            <List size={20} className="mr-2 text-yellow-500" />
            <h3 className="text-xl font-semibold text-white">Latest Discoveries</h3>
          </div>
          <ResultsList />
        </div>
        ...
        <div>
          <div className="flex items-center mb-3">
            <Network size={20} className="mr-2 text-yellow-500" />
