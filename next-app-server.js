...
app.prepare().then(() => {
  ...
  // Direct route for the search page to ensure it works with Replit's tools
  server.get('/search-direct', (req, res) => {
    res.setHeader('X-Frame-Options', 'ALLOWALL');
    res.setHeader('Access-Control-Allow-Origin', '*');
    res.send(`
      <!DOCTYPE html>
      ...
      <head>
        <meta charset="UTF-8">
        <meta name="viewport" content="width=device-width, initial-scale=1.0">
        <title>Intention-Ally Search Dashboard</title>
        <style>
          :root {
        ...
        <div class="app-container">
          <div class="sidebar">
            ...
            <div>
              ...
              <ul style="list-style: none; padding: 0;">
                <li style="padding: 8px 0;">Carbon Insetting</li>
                <li style="padding: 8px 0;">Sustainable Logistics</li>
                <li style="padding: 8px 0;">Scope 3 Emissions</li>
              </ul>
            </div>
          </div>
          ...
          <div class="content">
            <div class="header">
              ...
              <p>Track keywords, discover trends, and visualize semantic relationships</p>
            </div>
            
            <div class="search-bar">
              <div class="search-input-container">
                <input type="text" class="search-input" placeholder="Search a keyword, topic, or domain..." value="carbon insetting">
                <button class="search-button">Search</button>
              </div>
            </div>
            
            <div class="keyword-tags">
              <div class="keyword-tag active">carbon insetting</div>
              <div class="keyword-tag">sustainable logistics</div>
              <div class="keyword-tag">scope 3 emissions</div>
            </div>
            
            <div class="visualizations">
              <div class="visualization-card">
                <h2>Knowledge Graph</h2>
                <div style="background-color: #1A202C; height: 85%; border-radius: 4px; display: flex; align-items: center; justify-content: center;">
            ...
            <div class="results-container">
              <h2>Results for "carbon insetting"</h2>
              
              <div class="result-item">
                <h3 class="result-title">What is Carbon Insetting? Greener Logistics Starts Here</h3>
                <div class="result-meta">
                  <span>sustainablelogistics.com</span>
                  <span>Feb 10, 2024</span>
                  <span>definition</span>
                </div>
                <p class="result-description">Carbon insetting is the practice of investing in supply chain sustainability projects that benefit your business directly while reducing greenhouse gas emissions.</p>
                <a href="#" class="result-link">View Source</a>
              </div>
              
              <div class="result-item">
                <h3 class="result-title">Carbon Insetting vs. Carbon Offsetting: Key Differences</h3>
                <div class="result-meta">
                  <span>climateaction.org</span>
                  <span>Jan 15, 2024</span>
                  <span>comparison</span>
                </div>
                <p class="result-description">Unlike carbon offsetting which funds external projects, carbon insetting directly addresses emissions within your own value chain and offers multiple co-benefits.</p>
                <a href="#" class="result-link">View Source</a>
              </div>
              
              <div class="result-item">
                <h3 class="result-title">How Major Corporations Are Implementing Carbon Insetting</h3>
                <div class="result-meta">
                  <span>corporatesustainability.com</span>
                  <span>Nov 22, 2023</span>
                  <span>case studies</span>
                </div>
                <p class="result-description">Leading companies like Nestlé, L'Oréal, and Ben & Jerry's have implemented carbon insetting programs to reduce emissions in their supply chains while improving resilience.</p>
                <a href="#" class="result-link">View Source</a>
              </div>
            </div>
          </div>
  ...
  // Special route for the search page to ensure it works with Replit's tools
